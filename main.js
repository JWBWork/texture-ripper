...
// Hot reload in development — watches all files in the app directory
...
function createWindow() {
  ...
  // Build application menu with File > Save/Open
  const menuTemplate = [
    {
      label: 'File',
      submenu: [
...
// Save project: show save dialog, write file
ipcMain.handle('save-project', async (event, jsonData) => {
  const { filePath } = await dialog.showSaveDialog(mainWindow, {
    title: 'Save Project',
    defaultPath: 'project.trp',
...
// Open project: show open dialog, read file
